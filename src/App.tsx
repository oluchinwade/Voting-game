...
const contract_id = {
  ...
  txId: "4bc42cd55fe6f29f23750269e938d8182bceeeac652edfe32b33355cf722bf45",
  /** The output index */
  outputIndex: 0,
};
    ...
    <div className="App">
      ...
      >
        <Table>
          <TableHead>
            <TableRow>
              <TableCell align="center">Mercedes</TableCell>
              <TableCell align="center">Lamborghini</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <TableRow>
              ...
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"downloads"}
                    src={`${process.env.PUBLIC_URL}/${"downloads"}.jpeg`}
                  />
                </Box>
              </TableCell>
            </TableRow>
